...
const Course: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-pink-50/30 to-white overflow-x-hidden">
      {/* HERO */}
      ...
      {/* COURSES GRID */}
      <section id="courses" className="py-16 md:py-24 bg-gradient-to-b from-white via-pink-50/30 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
